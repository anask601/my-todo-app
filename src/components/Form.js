...
const Form = () => {
  ...
  return (
    <div className="">
      {/* <form
        className="flex flex-col h-40 text-white bg-pink-700 rounded-lg shadow-lg w-96 justify-evenly shadow-black"
      ...
      >
        ...
        <button className="inline-block w-20 p-1 bg-black justify-self-center">
          Submit!
        </button>
      </form> */}
